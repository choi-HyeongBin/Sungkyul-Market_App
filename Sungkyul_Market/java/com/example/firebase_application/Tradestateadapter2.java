...
public class Tradestateadapter2 extends RecyclerView.Adapter<Tradestateadapter2.CustomViewHolder> {
    ...
    public Tradestateadapter2(ArrayList<Conditioninformation> arrayList, Context context){
    ...
    public Tradestateadapter2.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.tradestate_list_item2,parent,false);
        Tradestateadapter2.CustomViewHolder holder= new Tradestateadapter2.CustomViewHolder(view);
    ...
    public void onBindViewHolder(@NonNull final CustomViewHolder holder, final int position) {
        ...
        holder.condition_useremail.setText(arrayList.get(position).getBuyeremail());
            ...
            public void onClick(View view) {
                ...
                dlg.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        hopperUpdates.put("selleragree","1");
                                        ...
                                        mmquery.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                for (DataSnapshot ds : snapshot.getChildren()) {
                                                    ...
                                                    Intent intent = new Intent(context, Tradestate2.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        ...
                        if(buyeragree.equals("1")) {
                            ...
                            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            context.startActivity(intent);
                            Toast.makeText(context,"구매자측 동의 안됨.",Toast.LENGTH_SHORT).show();
                        }
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public CustomViewHolder(@NonNull  View itemView) {
            ...
            this.condition_imv=itemView.findViewById(R.id.conditionlistitem2_imv1);
            this.condition_postname=itemView.findViewById(R.id.conditionlistitem2_tv3);
            this.condition_money=itemView.findViewById(R.id.conditionlistitem2_tv5);

            this.condition_useremail =itemView.findViewById(R.id.conditionlistitem2_tv4);
            this.btn1=itemView.findViewById(R.id.conditionlistitem2_btn1);
            this.btn2=itemView.findViewById(R.id.conditionlistitem2_btn2);
